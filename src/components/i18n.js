      ...
      ru: {
        translation: {
          "العربية": "Русский",
            ...
            "المسابقة الرمضانية": "Рамаданский конкурс",
            "السؤال:": "Вопрос:",
            "الإجابة": "Ответ",
            "الاسم": "Имя",
            "رقم الهاتف": "Номер телефона",
            "البلد": "Страна",
            "البريد الإلكتروني (اختياري)": "Электронная почта (по желанию)",
            "رحلة الحج": "Путешествие в хадж",
            "منصة تعليمية إسلامية متكاملة تقدم دروساً ومحاضرات في العلوم الشرعية والتربوية بأسلوب عصري مُيسّر": 
              'Полноценная исламская образовательная платформа, предлагающая уроки и лекции по шариатским и педагогическим наукам в современном упрощенном стиле',
